# Situation Classification and Social Calibration
...
|---|---|---|---|
| Information gap | Missing context, unclear request, different assumptions | Ask one discriminating question | Treating uncertainty as avoidance |
| Coordination failure | Ambiguous owner, timing, handoff, or channel | Define owner, action, date, and warning point | Treating process failure as disrespect |
| Resource or priority conflict | Incompatible deadlines, workload, budget, or access | Surface the trade-off to the decision owner | Framing capacity as attitude |
| Goal or criteria conflict | Different success measures or decision rules | Name interests and agree on criteria | Arguing positions indefinitely |
| Role or decision-right conflict | Overlapping authority or unclear mandate | Clarify who recommends, decides, executes, and reviews | Personalizing a governance gap |
| Process-fairness concern | Inconsistent treatment, no input, no explanation, no correction route | Ask for process, rationale, or review | Assuming an unfavorable outcome proves bias |
| Status or identity threat | Public correction, exclusion, credit loss, humiliation, or face threat | Reduce audience, restore factual standing, and protect dignity | Debating content while status injury escalates |
| Relationship or trust damage | Broken commitment, concealment, repeated unreliability, or failed repair | Name the breach and require remedy plus future evidence | Treating an apology as restored trust |
| Norm mismatch | Different expectations about response time, directness, privacy, or reciprocity | Make the norm discussable and negotiate it | Turning a local mismatch into a cultural stereotype |
| Safety or formal-route risk | Threat, coercion, retaliation exposure, protected concern, or material harm | Protect, document proportionately, and use a qualified route | Optimizing a clever confrontation |

Do not force one label when the evidence supports a compound problem. State
...
> The evidence shows ___. It is consistent with ___, but it does not establish
> ___. A plausible alternative is ___. The next move is ___ because it remains
> useful under both readings. Reassess if ___.
...
Use confidence words rather than numerical pseudo-precision:

- **low:** one ambiguous cue or second-hand report;
- **moderate:** repeated or convergent observations with material gaps;
- **high:** direct, repeated, independently supported behavior with few
...
- What did the user communicate, omit, assume, or delay?
- What feedback has the user actually received?
- Is their current action creating the response they dislike?
- What can they change without surrendering a legitimate boundary?
- Which part is structural or controlled by someone else?
...
- **Right-hand column:** what was actually said or done;
- **Left-hand column:** the user's private thoughts, predictions, and withheld
  concerns.
...
- kept private because disclosure adds harm without decision value;
- addressed through a safer or more authoritative route.

Do not recommend “radical honesty.” Useful disclosure is truthful,
decision-relevant, proportionate, and safe.
